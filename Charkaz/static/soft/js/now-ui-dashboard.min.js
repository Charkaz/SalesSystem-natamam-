...
seq = 0, delays = 80, durations = 500, seq2 = 0, delays2 = 80, durations2 = 500, $(document).ready(function () {
    ...
    showNotification: function (a, e) {
        color = "success", $.notify({
            icon: "now-ui-icons ui-1_check",
            message: "Təbriklər ,<b>Satışınız</b> - uğurla qeyd olundu."
        }, {
            type: color,
            timer: 8e3,
            placement: {
    ...
    showNotificationbad: function (a, e) {
        color = "danger", $.notify({
            icon: "now-ui-icons ui-1_bell-53",
            message: "Təssüf ,<b>Satışınızla bağlı problem</b> - zəhmət olmasa müştəri və məshul hissələrini boş saxlamayın."
        }, {
            type: color,
            timer: 8e3,
            placement: {
    ...
    showNotificationbos: function (a, e) {
        color = "warning", $.notify({
            icon: "now-ui-icons ui-1_bell-53",
            message: "Təssüf ,<b>Bazada</b> - secilen mehsuldan kifayet qeder yoxdur."
        }, {
            type: color,
            timer: 8e3,
            placement: {
